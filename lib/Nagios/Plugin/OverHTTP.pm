...
Nagios::Plugin::OverHTTP - The great new Nagios::Plugin::OverHTTP!
...
Perhaps a little code snippet.
    ...
    my $foo = Nagios::Plugin::OverHTTP->new();
    ...
...
Please report any bugs or feature requests to C<bug-nagios-plugin-overhttp at rt.cpan.org>, or through
the web interface at L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=Nagios-Plugin-OverHTTP>.  I will be notified, and then you'll
...
1; # End of Nagios::Plugin::OverHTTP
